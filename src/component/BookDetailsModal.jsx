...
export function BookDetailModal({item,BookDetailModalClose}) {
  ...
  return (
    <>
      ...
      <Modal  show={openModal}  onClose={() => setOpenModal(!openModal)}>
        ...
        <div className="flex bg-[#1e293b] rounded-sm w-[850px]">
          <div className="m-6 space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <button className="bg-white font-semibold uppercase shadow-sm rounded px-3" onClick={()=> BookDetailModalClose()}>close</button>
            </div>
          </div>
