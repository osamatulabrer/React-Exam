    ...
    return (
        ...
        <div className="flex justify-between items-center py-8 ">
            ...
            <ul className="flex space-x-3">
                ...
                <li className="w-[45px] h-[42px] border border-[#91efdd] bg-[#2ee0a5] bg-opacity-20   flex justify-center items-center rounded"><a href="#"><MdLightMode className="text-[#00d991]   text-2xl"/></a></li>
