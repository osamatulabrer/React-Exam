...
function LeftSideBer({onRelease,onUpcomming,onTranding,}) {
  ...
  const isCloseModal = ()=>{
    ...
    return (
      <div className="space-y-7 col-span-2 pt-8 mr-8 ml-2">
                  ...
                  <div onClick={()=>(onUpcomming())} className="hover:bg-[#00d991]  rounded-md flex items-center  py-3.5 mb-7.5 px-3 ">
                  ...
                  {isOpenModal && <FavoriteModal onClose={isCloseModal} />}
